...
void SSD1306_Display_Hx(float f, FontDef_t* Font, SSD1306_COLOR_t color){
	char buffer[20];
	float_to_string(f, buffer, 2);
//	sprintf(buffer, "Weg:%.2f", f); // @suppress("Float formatting support")
...
void SSD1306_Display_Unit(float price, FontDef_t* Font, SSD1306_COLOR_t color){
	char buffer[30];
	float_to_string(price, buffer, 2);
//	sprintf(buffer, "Unit:%.2f", price); // @suppress("Float formatting support")
	SSD1306_Puts(buffer, Font, color);
...
void SSD1306_Display_Price(float price, FontDef_t* Font, SSD1306_COLOR_t color){
	...
	float_to_string(price, buffer, 2);
//	sprintf(buffer, "Total:%.2f", price); // @suppress("Float formatting support")
	SSD1306_Puts(buffer, Font, color);
...
void SSD1306_Display_All(float f, float price, FontDef_t* Font, SSD1306_COLOR_t color){
	...
	SSD1306_Display_Hx(f, Font, color);
	SSD1306_GotoXY(10, 40);
	SSD1306_Display_Price(price, Font, color);
}
